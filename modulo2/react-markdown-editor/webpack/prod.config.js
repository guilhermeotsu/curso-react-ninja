...
// Vendor fica responsavel por armazenar todas as dependencias em comum entre os componentes.
// para que possa fazer cacheamento e nao precisar baixar ela sempre a cada requisição
module.exports = {
  entry: common.entry,
